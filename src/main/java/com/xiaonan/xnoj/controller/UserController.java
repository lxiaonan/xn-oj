...
import com.xiaonan.xnoj.common.DeleteRequest;
import com.xiaonan.xnoj.common.ErrorCode;
import com.xiaonan.xnoj.common.ResultUtils;
import com.xiaonan.xnoj.config.WxOpenConfig;
...
import com.xiaonan.xnoj.model.dto.user.UserAddRequest;
import com.xiaonan.xnoj.model.dto.user.UserLoginRequest;
import com.xiaonan.xnoj.model.dto.user.UserQueryRequest;
import com.xiaonan.xnoj.model.dto.user.UserRegisterRequest;
import com.xiaonan.xnoj.model.dto.user.UserUpdateMyRequest;
import com.xiaonan.xnoj.model.dto.user.UserUpdateRequest;
...
public class UserController {
     ...
     */
    @PostMapping("/add")
    // 添加这个注解：需要拥有管理员权限，才能执行当前方法，会通过aop切面来校验，是否拥有该权限
